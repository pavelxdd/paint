                             ...
                             const SDL_Rect *color_r)
{
    ...
    SDL_RenderFillRect(app->ren, brush_r);
    ...
    SDL_SetRenderDrawColor(app->ren,
                           ...
                           255);
    SDL_RenderFillRect(app->ren, water_r);
    ...
    if (app_is_straight_line_mode(app)) {
        ...
        SDL_SetRenderDrawColor(app->ren, yellow.r, yellow.g, yellow.b, 255);
        SDL_RenderFillRect(app->ren, line_r);
        SDL_SetRenderDrawColor(app->ren, dark_icon.r, dark_icon.g, dark_icon.b, 255);
    } else {
        SDL_Color bg_color_line = {40, 42, 54, 255}; // Dracula 'Background'
        SDL_SetRenderDrawColor(app->ren, bg_color_line.r, bg_color_line.g, bg_color_line.b, 255);
        SDL_RenderFillRect(app->ren, line_r);
        SDL_SetRenderDrawColor(app->ren, 248, 248, 242, 255); // Dracula 'Foreground'
    }
    ...
    SDL_SetRenderDrawColor(app->ren, bg_color.r, bg_color.g, bg_color.b, 255);
    SDL_RenderFillRect(app->ren, emoji_r);
    ...
    App *app, const SDL_Rect *brush_r, const SDL_Rect *water_r, const SDL_Rect *emoji_r)
{
    ...
    if (app->current_tool == TOOL_EMOJI) {
        ...
        has_emoji = emoji_renderer_get_default_texture_info(
            app->palette->emoji_renderer_instance, &emoji_tex, &emoji_w, &emoji_h);
    }
...
void tool_selectors_draw(App *app, int start_y)
{
    ...
    draw_backgrounds(app,
                     ...
                     &emoji_toggle_rect,
                     &color_toggle_rect);
    draw_previews(app, &brush_toggle_rect, &water_marker_toggle_rect, &emoji_toggle_rect);
